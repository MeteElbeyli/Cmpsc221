...
// I was recommended by my friends to add this just in case you do ever divide by 0



class CustomABOUTDialog extends JDialog implements
        ActionListener {
    JButton jbnOk;
